...
public class WixEmbeddedMySqlTest {
    ...
    /**
     * Download takes a lot of time, since MySQL 5.7 distribution is around 600MB
     * Doesn't work on Ubuntu 16.04 - fails to find libaio.so.1
     * (install manually with `sudo apt -y install libaio1`)
     */
