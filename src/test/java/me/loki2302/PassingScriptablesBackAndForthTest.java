...
public class PassingScriptablesBackAndForthTest {
	@Test
	public void canPassScriptableObjectToJavaScript() throws IllegalAccessException, 
	...
	@Test
	public void canGetScriptableJavaObjectFromJavaScript() throws IllegalAccessException, 
		InstantiationException, InvocationTargetException {
        ...
        try {
        	...
        	String script = 
        			"function makePerson() { return new Person(123, 'loki2302'); };";
